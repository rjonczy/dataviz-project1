...
In this data exploratory of Gistemp data we will focus on data visualisation.
...
* X-axis: Year
* Y-axis: Deviations
* Subset of data: Dataset contains observations between 1880-2014, for visualisation following years have been chosen: 1950-1990, for further analysis we will focus on 1960-1980, which were marke as START and STOP date
* Seasons
